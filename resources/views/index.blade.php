	...
	<body>
		...
		<div class="th-menu-wrapper">
			<div class="th-menu-area text-center">
				...
				<div class="mobile-logo"><a href="index.html"><img src="{{ asset('assets/img/logo.svg') }}" alt="Edura"></a></div>
				...
				<div class="menu-area">
					<div class="container">
						<div class="row align-items-center justify-content-between">
							<div class="col-auto">
								<div class="header-logo"><a href="index.html"><img src="{{ asset('assets/img/logo.svg') }}" alt="Edura"></a></div>
							</div>
							<div class="col-auto">
								<div class="row">
									<div class="col-auto">
									...
									<div class="col-auto d-none d-xl-block">
										<div class="header-button"><button type="button" class="icon-btn searchBoxToggler"><i class="far fa-search"></i></button> <a href="wishlist.html" class="icon-btn"><i class="far fa-heart"></i> <span class="badge">3</span> </a><button type="button" class="icon-btn sideMenuToggler"><i class="far fa-shopping-cart"></i> <span class="badge">5</span></button> <a href="contact.html" class="th-btn ml-25">Contact Us <i class="fas fa-arrow-right ms-1"></i></a></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row align-items-center justify-content-center">
							<div class="col-md-6">
								<div class="hero-style1">
									...
									<div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s"><a href="contact.html" class="th-btn style3">Get Started<i class="fas fa-arrow-right ms-2"></i></a></div>
								</div>
							</div>
		...
		<section class="space overflow-hidden" data-bg-src="{{ asset('assets/img/bg/course_bg_2.png') }}" id="course-sec">
			<div class="container">
				...
				<div class="course-tab-1 tab-menu1 th-carousel row" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3" data-md-slide-show="2" data-sm-slide-show="1" data-arrows="true" id="courseTab-1" data-asnavfor="#course-tab-content">
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon1.svg') }}" alt="img"></span><span class="details"><span class="box-title">Web Development</span> <span class="text">286 Courses</span></span></a></div>
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon2.svg') }}" alt="img"></span><span class="details"><span class="box-title">Digital Marketing</span> <span class="text">286 Courses</span></span></a></div>
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon1.svg') }}" alt="img"></span><span class="details"><span class="box-title">UI/UX Design</span> <span class="text">140 Courses</span></span></a></div>
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon1.svg') }}" alt="img"></span><span class="details"><span class="box-title">Graphic Design</span> <span class="text">245 Courses</span></span></a></div>
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon1.svg') }}" alt="img"></span><span class="details"><span class="box-title">Web Development</span> <span class="text">286 Courses</span></span></a></div>
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon2.svg') }}" alt="img"></span><span class="details"><span class="box-title">Digital Marketing</span> <span class="text">286 Courses</span></span></a></div>
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon1.svg') }}" alt="img"></span><span class="details"><span class="box-title">UI/UX Design</span> <span class="text">140 Courses</span></span></a></div>
					<div class="col-lg-3"><a class="tab-btn"><span class="icon"><img src="{{ asset('assets/img/icon/course-tab-icon1.svg') }}" alt="img"></span><span class="details"><span class="box-title">Graphic Design</span> <span class="text">245 Courses</span></span></a></div>
				...
				<div class="th-carousel" data-fade="true" id="course-tab-content" data-adaptive-height="true">
						...
						<div class="row gy-4 mb-60">
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_1.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 03 WEEKS</span></div>
									<div class="course-content">
										...
										<h3 class="course-title"><a href="course-details.html">Education Software and PHP and JS System Script</a></h3>
										<div class="course-meta"><span><i class="fal fa-file"></i>Lesson 8</span> <span><i class="fal fa-user"></i>Students 60+</span> <span><i class="fal fa-chart-simple"></i>Beginner</span></div>
										<div class="course-author">
											<div class="author-info"><img src="{{ asset('assets/img/course/author.png') }}" alt="author"> <a href="course.html" class="author-name">Max Alexix</a></div>
							...
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_2.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 02 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
										</div>
										<h3 class="course-title"><a href="course-details.html">Learn Figma – UI/UX Design Essential Training</a></h3>
										<div class="course-meta"><span><i class="fal fa-file"></i>Lesson 9</span> <span><i class="fal fa-user"></i>Students 50+</span> <span><i class="fal fa-chart-simple"></i>Beginner</span></div>
										<div class="course-author">
											<div class="author-info"><img src="{{ asset('assets/img/course/author.png') }}" alt="author"> <a href="course.html" class="author-name">Kevin Perry</a></div>
											<div class="offer-tag">Free</div>
										</div>
									</div>
								</div>
							...
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_3.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 04 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
										</div>
										<h3 class="course-title"><a href="course-details.html">Advanced Android 12 & Kotlin Development Course</a></h3>
										<div class="course-meta"><span><i class="fal fa-file"></i>Lesson 7</span> <span><i class="fal fa-user"></i>Students 30+</span> <span><i class="fal fa-chart-simple"></i>Beginner</span></div>
										<div class="course-author">
											<div class="author-info"><img src="{{ asset('assets/img/course/author.png') }}" alt="author"> <a href="course.html" class="author-name">Max Alexix</a></div>
											<div class="offer-tag">Free</div>
										</div>
							...
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_4.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 02 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
										</div>
										<h3 class="course-title"><a href="course-details.html">IT Statistics Data Science and Business Analysis</a></h3>
										<div class="course-meta"><span><i class="fal fa-file"></i>Lesson 10</span> <span><i class="fal fa-user"></i>Students 20+</span> <span><i class="fal fa-chart-simple"></i>Beginner</span></div>
										<div class="course-author">
											<div class="author-info"><img src="{{ asset('assets/img/course/author.png') }}" alt="author"> <a href="course.html" class="author-name">Kevin Perry</a></div>
											<div class="offer-tag">Free</div>
										</div>
					...
					<div>
						<div class="row gy-4 mb-60">
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_2.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 03 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
							...
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_1.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 02 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
							...
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_4.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 04 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
							...
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_3.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 02 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
					...
					<div>
						<div class="row gy-4 mb-60">
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_4.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 03 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
					...
					<div>
						<div class="row gy-4 mb-60">
							<div class="col-md-6 col-xxl-3 col-lg-4">
								<div class="course-box">
									<div class="course-img"><img src="{{ asset('assets/img/course/course_1_3.png') }}" alt="img"> <span class="tag"><i class="fas fa-clock"></i> 03 WEEKS</span></div>
									<div class="course-content">
										<div class="course-rating">
											<div class="star-rating" role="img" aria-label="Rated 4.00 out of 5"><span style="width:79%">Rated <strong class="rating">4.00</strong> out of 5</span></div>
											(4.7)
				...
				<div class="text-center"><a href="course.html" class="th-btn">View All Courses<i class="fa-solid fa-arrow-right ms-2"></i></a></div>
			</div>
		</section>
		<div class="space">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-xl-6">
						<div class="ps-xxl-5 ms-xl-2">
							<div class="video-box2"><img src="{{ asset('assets/img/update1/normal/video_3.jpg') }}" alt="video"> <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn popup-video"><i class="fas fa-play"></i></a></div>
						</div>
					</div>
				</div>
			</div>
		...
		<section class="cta-area-2 position-relative space-bottom">
			...
			<div class="container text-center">
				<div class="cta-wrap2">
					...
					<div class="btn-group justify-content-center"><a href="about.html" class="th-btn style3">Join With Us<i class="fas fa-arrow-right ms-2"></i></a> <a href="contact.html" class="th-btn style2">Become A Teacher<i class="fas fa-arrow-right ms-2"></i></a></div>
				</div>
			</div>
		</section>
					...
					<div class="col-lg-6">
						<div class="team-card style2">
							<div class="team-img-wrap">
								...
								<div class="team-img"><img src="{{ asset('assets/img/team/team_2_2.jpg') }}" alt="Team"></div>
								<div class="team-social">
									<a href="#" class="icon-btn"><i class="far fa-plus"></i></a>
									<div class="th-social"><a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a> <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a> <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a></div>
								</div>
					...
					<div class="col-lg-6">
						<div class="team-card style2">
							<div class="team-img-wrap">
								...
								<div class="team-img"><img src="{{ asset('assets/img/team/team_2_3.jpg') }}" alt="Team"></div>
								<div class="team-social">
									<a href="#" class="icon-btn"><i class="far fa-plus"></i></a>
									<div class="th-social"><a target="_blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a> <a target="_blank" href="https://facebook.com/"><i class="fab fa-facebook-f"></i></a> <a target="_blank" href="https://instagram.com/"><i class="fab fa-instagram"></i></a></div>
								</div>
		...
		<section class="testi-area-2 space overflow-hidden">
						...
						<div class="row testi-slider2 th-carousel" data-slide-show="1" data-lg-slide-show="1" data-md-slide-show="1" data-arrows="true">
							<div class="col-lg-6">
								<div class="testi-card">
									...
									<p class="testi-card_text">“They took the time to thoroughly inspect my roof and identify all of the issues, and then came up with a comprehensive plan to address them. The team was skilled and efficient, and completed the job and holds various program-specific accreditations, ensuring that the institution holds various program-specific meets rigorous standards of academic quality and integrity.”</p>
									<div class="testi-card_profile">
										<div class="testi-card_avater"><img src="{{ asset('assets/img/testimonial/testi_1_1.jpg') }}" alt="testimonial"></div>
										<div class="media-body">
											<h3 class="testi-card_name">Ronald Richards</h3>
											<span class="testi-card_desig">Founder CEO</span>
											<div class="testi-box_review"><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i> (4.7)</div>
										</div>
									</div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="testi-card">
									<div class="testi-card_quote"><img src="{{ asset('assets/img/icon/testi-quote.svg') }}" alt="quote"></div>
									<p class="testi-card_text">“Quickly maximize visionary solutions after mission critical action item productivity premium portals for impactful -services inactively negotiate enabled niche markets via growth strategies. University is accredited by the Higher Learning Commission and holds various program-specific accreditations, ensuring that the institution meets rigorous standards of academic quality and integrity.”</p>
									<div class="testi-card_profile">
										<div class="testi-card_avater"><img src="{{ asset('assets/img/testimonial/testi_1_2.jpg') }}" alt="testimonial"></div>
										<div class="media-body">
											<h3 class="testi-card_name">Zara Head Milan</h3>
											<span class="testi-card_desig">IT Student</span>
											<div class="testi-box_review"><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i><i class="fa-solid fa-star-sharp"></i> (4.7)</div>
										</div>
									</div>
								</div>
		...
		<section class="bg-title position-relative" data-bg-src="assets/img/bg/admission-bg1.png') }}">
			...
			<div class="container space z-index-common">
				<div class="row justify-content-end">
					<div class="col-xl-6">
						<div class="title-area mb-30">
							<span class="sub-title">Booking Appointment</span>
						...
						<form class="course-form mb-2" action="#">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group"><input type="date" name="number" id="number" placeholder="Inspection Date*"></div>
								</div>
								<div class="col-lg-6">
									<div class="form-group"><input type="text" name="subject" id="subject" placeholder="Subject*"></div>
								</div>
							</div>
						</form>
						<a href="course.html" class="th-btn style3">Make an Appointment<i class="fas fa-arrow-right ms-2"></i></a>
					</div>
				</div>
			</div>
		</section>
				...
				<div class="container">
					<div class="footer-contact-wrap">
						<div class="footer-contact">
							...
							<div class="media-body">
								<p class="footer-contact_text">Toll Free Customer Care</p>
								<a href="tel+11234567890" class="footer-contact_link">+(1) 123 456 7890</a>
							</div>
						</div>
						...
						<div class="footer-contact">
							...
							<div class="media-body">
								<p class="footer-contact_text">Need live support?</p>
								<a href="mailto:hi@aduca-edu.com" class="footer-contact_link">hi@edura.com</a>
							</div>
						</div>
						<div class="divider"></div>
						<div class="footer-contact">
					...
					<div class="row justify-content-between">
						<div class="col-md-6 col-xl-3">
							<div class="widget newsletter-widget footer-widget style2">
								<div class="newsletter-logo mb-30"><a href="index.html"><img src="{{ asset('assets/img/logo-white.svg') }}" alt="Edura"></a></div>
						...
						<div class="col-md-6 col-xl-auto">
							<div class="widget footer-widget style2">
								...
								<div class="sidebar-gallery">
									<div class="gallery-thumb"><img src="{{ asset('assets/img/update1/widget/gal-1-1.jpg') }}" alt="Gallery Image"> <a href="assets/img/update1/widget/gal-1-1.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a></div>
									<div class="gallery-thumb"><img src="{{ asset('assets/img/update1/widget/gal-1-2.jpg') }}" alt="Gallery Image"> <a href="assets/img/update1/widget/gal-1-2.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a></div>
									<div class="gallery-thumb"><img src="{{ asset('assets/img/update1/widget/gal-1-3.jpg') }}" alt="Gallery Image"> <a href="assets/img/update1/widget/gal-1-3.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a></div>
									<div class="gallery-thumb"><img src="{{ asset('assets/img/update1/widget/gal-1-4.jpg') }}" alt="Gallery Image"> <a href="assets/img/update1/widget/gal-1-4.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a></div>
									<div class="gallery-thumb"><img src="{{ asset('assets/img/update1/widget/gal-1-5.jpg') }}" alt="Gallery Image"> <a href="assets/img/update1/widget/gal-1-5.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a></div>
									<div class="gallery-thumb"><img src="{{ asset('assets/img/update1/widget/gal-1-6.jpg') }}" alt="Gallery Image"> <a href="assets/img/update1/widget/gal-1-6.jpg') }}" class="gallery-btn popup-image"><i class="fab fa-instagram"></i></a></div>
								</div>
							</div>
						</div>
					</div>
